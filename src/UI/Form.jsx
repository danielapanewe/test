...
function Form() {
    ...
    // };
    return (
        <div className="containers pt-16 mt-8">
            <div className="grid grid-cols-1 lg:grid-cols-2">
                <div className=" bg-white py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none border border-gray-200">
                    <div className=" px-8 ">
                        <h1 className="xl:text-4xl text-3xl pb-4 text-textcolor font-bold">
                            Nous contacter
                        </h1>
                        <p className=" text-textcolor pb-8 lg:pr-4">
                        ...
                        <div className="flex pb-4 items-center">
                            ...
                            >
                                ...
                                <a
                                    ...
                                    className="pl-4 text-textcolor text-base"
                                >
                                    +49 152 3191 8349
                                </a>
                            </a>
                        ...
                        >
                            ...
                            <p className="pl-4 text-textcolor text-base">
                                info@cm.dagstra.com
                            </p>
                        </a>
                        ...
                        <p className="text-lg text-textcolor pt-10 tracking-wide">
                ...
                <div className=" bg-gray-200 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
                    ...
                    >
                        ...
                        <div className="w-full mt-6">
                            ...
                            <button
                                type="submit"
                                className="px-4 py-2 focus:outline-none transition duration-150 ease-in-out  rounded text-white btn bg-primarycolor"
                            >
                                Envoyer
                            </button>
                        </div>
