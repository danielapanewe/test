        ...
        <section className="mt-12">
            <div className="containers ">
                ...
                <Title
                    ...
                    subtitle={'Quelques avis de nos fidèles Clients'}
                />
                </div>
              
                <Swiper
                    className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 md:gap-8 pb-8"
                    spaceBetween={50}
                    slidesPerView={1}
                    autoplay={{
                        delay: 2500,
                ...
                >
                    {slides.map((slideitem) => (
                        <SwiperSlide key={slideitem.id}>
                            <div className="rounded-sm shadow-xl p-8 mt-7">
